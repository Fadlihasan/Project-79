          ...
          <div class="relative">
            ...
            <div class="p-9">
              ...
              <input class="w-full mt-5 rounded-xl border p-2 mb-3" type="email" name="email" placeholder="Email" />
               <div class="relative">
              <input class="w-full rounded-xl border p-2" type="password" name="password" id="password-field" placeholder="Password" />
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="gray" toggle="#password-field" class="fa fa-eye absolute right-3 top-1/2 -translate-y-1/2 field-icon toggle-password" viewBox="0 0 16 16">
